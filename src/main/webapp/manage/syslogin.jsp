...
<TABLE style="MARGIN: auto; WIDTH: 100%; HEIGHT: 100%" border=0
	...
	<TBODY>
		...
		<TR style="HEIGHT: 254px">
			...
			<DIV style="BACKGROUND-COLOR: #8a8396">
			<DIV style="MARGIN: 0px auto; WIDTH: 936px">
			<DIV
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				<TBODY>
					<TR>
						<td>用户名：</td>
						<TD style="HEIGHT: 45px"><INPUT type="text" class=input value="${manager.name }" name="name" id="name"></TD>
					</TR>
					<TR>
						<td>密码：</td>
						<TD><INPUT type="password" class=input value="${manager.password }" name="password" id="password"/></TD>
					</TR>
				</TBODY>
			</TABLE>
			</DIV>
