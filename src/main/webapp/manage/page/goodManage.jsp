...
<script type="text/javascript">
	...
	function openUserAddDialog() {
		...
		url = "${pageContext.request.contextPath}/manage/user/save";
	}
	...
	function openUserModifyDialog() {
		...
		$("#fm").form("load", row);
		url = "${pageContext.request.contextPath}/manage/user/save?userId=" + row.id;
	}
...
<body style="margin: 1px">
	...
	<table id="dg" title="拍品管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true"
		url="${pageContext.request.contextPath}/manage/good/list" fit="true"
		toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="goodId" width="50" align="center">拍品编号</th>
				<th field="goodName" width="50" align="center">拍品名称</th>
				<th field="price" width="50" align="center">拍品一口价</th>
				<th field="currPrice" width="50" align="center">当前价</th>
				<th field="beginPrice" width="50" align="center">起始价</th>
				<th field="goodState" width="50" align="center">状态</th>
				<%--<th id="" field="registerTime" width="50" align="center">注册时间</th>--%>
				<th field="buyerId" width="50" align="center">购买者</th>
				<th field="sellerId" width="50" align="ce	nter">卖者</th>
				<th field="isDelete" width="50" align="center">是否删除</th>
	...
	<div id="tb">
		...
		<div>
			&nbsp;用户名：&nbsp;<input type="text" id="goodName" size="20"
