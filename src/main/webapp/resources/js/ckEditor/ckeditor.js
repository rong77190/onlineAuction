...
(function() {
        ...
        CKEDITOR.tools = {
            ...
            createClass: function(a) {
                ...
                if (l)
                    ...
                    ;
                c && (b.prototype = this.prototypedCopy(c.prototype),
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getIndex: function(a) {
            ...
            while (b = b.previousSibling);return c
        },
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    ...
                    c = d.$.scrollTop || g.scrollTop) : (c = A ? d.$ : g,
                    b = c.scrollLeft,
                    c = c.scrollTop),
                    b = e.left + b - y,
                    c = e.top + c - m)
                    ...
                    for (m = this,
                    y = null ; m && "body" != m.getName() && "html" != m.getName(); ) {
                ...
                a && (e = this.getWindow(),
                m = a.getWindow(),
                !e.equals(m) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a),
                b += a.x,
                c += a.y));
                document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || A || (b += this.$.clientLeft ? 1 : 0,
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function m(a, b) {
                    ...
                    f = a.getWindow();
                    f.equals(b) || (f = m(CKEDITOR.dom.element.get(f.$.frameElement), b),
                    c.x += f.x,
                    c.y += f.y);
                    return c
                }
    ...
    (function() {
        function a(a, b) {
            ...
            (f = 0 < z ? f.getChild(z - 1) : !1 === x(f, !0) ? null  : f.getPreviousSourceNode(!0, p, x)) : (f = d,
            f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === x(d, !0) ? null  : d.getNextSourceNode(!0, p, x)))),
            f && !1 === x(f) && (f = null ));
            for (; f && !this._.end; ) {
                this.current = f;
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function m(a, b, c, f) {
                ...
                if (f && l)
                    return d;
                k || f ? b.append(a.clone(!0, e), c) : (a.remove(),
                x && b.append(a));
                return d
            }
            function g() {
            ...
            function h() {
                ...
                CKEDITOR.POSITION_BEFORE_START) : J == b + 1 && B ? a.moveToPosition(H[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(H[b + 1], CKEDITOR.POSITION_BEFORE_START),
                d && (b = w[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document),
                c.insertAfter(b),
                b.mergeSiblings(!1),
                a.moveToBookmark({
                    startNode: c
            ...
            if (k && n.type == CKEDITOR.NODE_TEXT && p.equals(n))
                p = a.document.createText(p.substring(D, r)),
                c.append(p);
            else {
                n.type == CKEDITOR.NODE_TEXT ? k ? S = !0 : n = n.split(r) : 0 < n.getChildCount() ? r >= n.getChildCount() ? (n = n.getChild(r - 1),
                B = !0) : n = n.getChild(r) : q = B = !0;
                p.type == CKEDITOR.NODE_TEXT ? k ? M = !0 : p.split(D) : 0 < p.getChildCount() ? 0 === D ? (p = p.getChild(D),
                F = !0) : p = p.getChild(D - 1) : t = F = !0;
        ...
        CKEDITOR.dom.range.prototype = {
                ...
                function a(c) {
                    ...
                    if (f.type == CKEDITOR.NODE_TEXT) {
                        ...
                        for (g = 0; (e = e.getPrevious()) && e.type == CKEDITOR.NODE_TEXT; )
                            g += e.getLength();
                        e = g;
                        f.getText() ? d += e : (g = f.getPrevious(b),
                        e ? (d = e,
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    r.type == CKEDITOR.NODE_TEXT ? (B && (r = !CKEDITOR.tools.trim(r.substring(0, B)).length && r,
                    D = !!r),
                    r && ((p = r.getPrevious()) || (k = r.getParent()))) : 
                    ...
                    for (k = c(k); k || p; ) {
                        if (k && !p) {
                            ...
                            if (e ? k.isBlockBoundary() : !h.contains(k))
                                break;
                            D && "inline" == k.getComputedStyle("display") || (D = !1,
                            n ? l = k : this.setStartBefore(k));
                            p = k.getPrevious()
                        }
                        for (; p; )
                            if (r = !1,
                            p.type == CKEDITOR.NODE_COMMENT)
                                p = p.getPrevious();
                            else {
                    ...
                    k = p = null ;
                    n = D = !1;
                    r.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(r.substring(B)).length ? D = !0 : (D = !r.getLength(),
                    B == r.getLength() ? (p = r.getNext()) || 
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    m && m.type == CKEDITOR.NODE_TEXT && (h ? h >= m.getLength() ? d.setEndAfter(m) : (d.setEndAfter(m),
                    x = 0) : d.setEndBefore(m));
            ...
            splitBlock: function(a, b) {
                ...
                this.deleteContents();
                e && e.equals(m) && (d ? (g = new CKEDITOR.dom.elementPath(this.startContainer,this.root),
                this.moveToPosition(m, CKEDITOR.POSITION_AFTER_END),
                m = null ) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer,this.root),
                this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START),
                e = null ) : (m = this.splitElement(e, b || !1),
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    ...
                    d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, g; e && !e.equals(d.root) && !e.getFirst(a(e)); )
                        g = e.getParent(),
            ...
            moveToClosestEditablePosition: function(a, b) {
                ...
                if (a && !a.is(CKEDITOR.dtd.$block))
                    ...
                    d = 1,
                    (m = e.type == 
                    CKEDITOR.NODE_ELEMENT) && e.is(CKEDITOR.dtd.$block) && "false" == e.getAttribute("contenteditable") ? (c.setStartAt(e, CKEDITOR.POSITION_BEFORE_START),
                    c.setEndAt(e, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && m && e.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(e, 0),
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    m.collapsed || (h = new CKEDITOR.dom.walker(m.clone()),
                    ...
                    h.evaluator = y,
                    h = h.previous(),
                    this._.lastNode = h.getNextSourceNode(!0, null , m.root),
                    this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (y = this.range.clone(),
                    ...
                    this._.lastNode && m.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = m.document.createText(""),
                ...
                for (this._.nextNode = null ; y; ) {
                    ...
                    if (x)
                        ...
                        if (CKEDITOR.dtd.$block[p] && "false" == y.getAttribute("contenteditable")) {
                            ...
                            h && (h.setEndAt(y, CKEDITOR.POSITION_BEFORE_START),
                            "br" != p && (this._.nextNode = y));
                            E = 1
                        } else {
                            if (y.getFirst()) {
                                h || (h = this.range.clone(),
                                h.setStartAt(y, CKEDITOR.POSITION_BEFORE_START));
                                y = y.getFirst();
                                continue
                            }
                            x = 1
                ...
                if (!d) {
                    ...
                    d = d.block;
                    !d && y && !this.enforceRealBlocks && E[y.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !y.equals(h.root) ? d = y : !d || this.enforceRealBlocks && d.is(q) ? (d = this.range.document.createElement(a),
                    h.extractContents().appendTo(d),
                    d.trim(),
                    h.insertNode(d),
                    u = C = !0) : "li" != d.getName() ? h.checkStartOfBlock() && h.checkEndOfBlock() || (d = d.clone(!1),
                    h.extractContents().appendTo(d),
                    d.trim(),
                    C = h.splitBlock(),
                    u = !C.wasStartOfBlock,
                    C = !C.wasEndOfBlock,
                    h.insertNode(d)) : A || (this._.nextNode = d.equals(m) ? null  : this._getNextSourceNode(h.getBoundaryNodes().endNode, 
                    1, m))
                }
    ...
    (function() {
        ...
        function u(a, b, k, e) {
            ...
            if (e.doFilter) {
                ...
                if (!a.allAttributes)
                    for (B in f)
                        h[B] || (L.test(B) ? B == (H = B.replace(/^data-cke-saved-/, "")) || h[H] || (delete f[B],
                        w = !0) : (delete f[B],
                        w = !0));
                ...
                if ("br" == b)
                    ...
                    b: {
                        ...
                        for (var e = 0, p = d.length, n; e < p; ++e)
                            if (n = d[e],
                            n.type == CKEDITOR.NODE_ELEMENT && !k[n.name]) {
                                k = !1;
                                break b
                            }
                        k = !0
                    ...
                    if (k)
                        ...
                        k = a.parent;
                        for (var e = k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == k.name, r, f, p = d.length; 0 < p; )
                            n = d[--p],
                            e && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && B.$inline[n.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b),
                            r.insertAfter(a),
                            c.push({
                                check: "parent-down",
                                el: r
                            ...
                            f = B[k.name] || B.span,
                            n.insertAfter(a),
                            k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n.type != CKEDITOR.NODE_ELEMENT || f[n.name] || c.push({
                                check: "el-up",
                                el: n
                            }));
                        a.remove()
        ...
        function p(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (k = c[d],
                !(k.check && !a.check(k.check, !1) || k.left && !k.left(b))) {
                    k.right(b, O);
                    break
                }
        }
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                this.allow(M[a.enterMode] + " " + M[a.shiftEnterMode], "default", 
                1),
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                for (; x = a.pop(); )
                    if (c = x.el,
                    c.parent)
                        switch (g = B[c.parent.name] || B.span,
                        x.check) {
                        case "it":
            ...
            addContentForms: function(a) {
                if (!this.disabled && a) {
                    ...
                    for (b = 0; b < a.length && !k; ++b)
                        c = a[b],
                        ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (k = c);
                    if (k) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (k = 0; k < a.length; ++k) {
                        ...
                        for (p = 0; p < b.length; ++p)
                            ...
                            m = n.right),
                            e || (e = n,
                            e = e.element ? e.element : f ? f.match(/^([a-z0-9]+)/i)[0] : 
                            e.left.getDefinition().element),
                            x instanceof CKEDITOR.style && (x = r(x)),
                            c.push({
                                check: f == e ? null  : f,
                                left: x,
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    n = d.attributes || {},
                    k ? (k = L(k),
                    n.style = CKEDITOR.tools.writeCssText(k, !0)) : k = {},
                    k = {
                        name: d.element,
                        attributes: n,
        ...
        return {
            load: function(b, c, e, g) {
                ...
                if (0 === l)
                    ...
                    var z = function(a, b) {
                        (b ? q : t).push(a);
                        0 >= --l && (g && CKEDITOR.document.getDocumentElement().removeStyle("cursor"),
                        f(b))
                    }
                      , A = function(b, c) {
                        a[b] = 1;
              ...
              , h = function(b) {
                a.call(this, b, function(a) {
                    ...
                    for (f in a) {
                        ...
                        if (!d[f]) {
                            if (l.icons)
                                for (var u = l.icons.split(","), C = u.length; C--; )
                    ...
                    if (b.length)
                        ...
                        for (f in g)
                            l = g[f],
                            l.onLoad && !l.onLoad._called && (!1 === l.onLoad() && delete g[f],
                            l.onLoad._called = 1);
                        c && c.call(e || window, g)
                    }
                }, this)
        ...
        function z(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var f in c) {
                    ...
                    g && !a.lang[f] && (g.split && (g = g.split(",")),
                    0 <= CKEDITOR.tools.indexOf(g, a.langCode) ? h = a.langCode : (h = a.langCode.replace(/-.*/, ""),
                    h = h != a.langCode && 0 <= CKEDITOR.tools.indexOf(g, h) ? h : 0 <= CKEDITOR.tools.indexOf(g, "en") ? "en" : g[0]),
                    x.langEntries && x.langEntries[h] ? (a.lang[f] = x.langEntries[h],
                    h = null ) : e.push(CKEDITOR.getUrl(x.path + "lang/" + h + ".js")));
                    k.push(h);
                    d.push(x)
                }
    ...
    (function() {
        ...
        function(g, h, l) {
            function q(a) {
                ...
                if (0 < y.length)
                    for (var c = 0; c < y.length; c++) {
                        ...
                        f && !f[k] || a && e && !e[a] && CKEDITOR.dtd[a] ? k == v.name && (z(v, v.parent, 1),
                        c--) : (b || (t(),
                        b = 1),
                        d = d.clone(),
                        d.parent = v,
            ...
            function z(b, c, d) {
                ...
                "pre" == b.name && (k = !1),
                "textarea" == b.name && (x = !1));
                b.returnPoint ? (v = b.returnPoint,
                delete b.returnPoint) : v = d ? c : e
            }
            function A(a, b) {
            ...
            C.onTagOpen = function(e, n, f, r) {
                ...
                if (a(n))
                    ...
                    if ("br" == e)
                        ...
                        for (; !(r = (f = v.name) ? CKEDITOR.dtd[f] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c,
                        n.isUnknown || v.isUnknown || r[e]); )
                            if (v.isOptionalClose)
                                C.onTagClose(f);
                            else if (e in b && f in b)
                                f = v.children,
                                (f = f[f.length - 1]) && "li" == f.name || z(f = new CKEDITOR.htmlParser.element("li"), v),
                                !n.returnPoint && (n.returnPoint = v),
                                v = f;
                            ...
                            !u(e, f))
                                ...
                                !n.returnPoint && (n.returnPoint = v),
                                v = v.parent;
                            else if (f in CKEDITOR.dtd.$inline && y.unshift(v),
                            v.parent)
                                z(v, v.parent, 1);
                            else {
                                n.isOrphan = 1;
            ...
            C.onTagClose = function(a) {
                ...
                for (var c = [], d = [], k = v; k != m && k.name != a; )
                    k._.isBlockLike || d.unshift(k),
                    c.push(k),
                    k = k.returnPoint || k.parent;
                if (k != m) {
            ...
            ;
            C.onText = function(a) {
                if (!(v._.hasInlineStarted && !E.length || k || x) && (a = CKEDITOR.tools.ltrim(a),
                0 === a.length))
                    return;
                var b = v.name
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a, 
            c, d) {
                for (var g = [this.findIndex(c), 0], h = 0, l = a.length; h < l; h++)
                    g.push({
                        value: a[h],
                        priority: c,
                        options: d
            ...
            execOnName: function(a, c) {
                for (var d = 0, g = this.rules, h = g.length, l; c && d < h; d++)
                    l = g[d],
    ...
    (function() {
        function a(a, d) {
                    ...
                    if (k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (p)
                            for (f(p, 1) && e.push(p); p; )
                                g(p) && (r = c(p)) && f(r) && ((w = c(r)) && !g(w) ? e.push(r) : (n(x).insertAfter(r),
                                r.remove())),
                                p = p.previous;
                        ...
                        if (e = !a || !1 !== ("function" == typeof d ? d(k) : d))
                            ...
                            k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? x || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || k.name in CKEDITOR.dtd.tr || k.name in CKEDITOR.dtd.$listItem) ? (e = b(k),
                            e = !e || "form" == k.name && "input" == e.name) : e = !1 : e = !1;
                        e && k.add(n(a))
                    }
                }
            }
            function f(a, b) {
                ...
                a.value = c[0]),
                !CKEDITOR.env.needsBrFiller && x && (!b || a.parent.name in w) || !x && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
            }
            var r = {
                elements: {}
            }, x = "html" == d, w = CKEDITOR.tools.extend({}, k), D;
            for (D in w)
                "#" in v[D] || delete w[D];
            for (D in w)
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) {
                ...
                var e;
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == k && (k = "div",
                ...
                k && (e = c,
                !e.children.length && CKEDITOR.dtd[e.name][k] && (k = new CKEDITOR.htmlParser.element(k),
                e.add(k)));
                a.dataValue = c
            }, null , null , 5);
            b.on("toHtml", function(a) {
            ...
            elements: {
                ...
                table: function(a) {
                    a.children.slice(0).sort(function(a, b) {
                        var c, d;
                        a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(x, a.name),
        ...
        function a(a) {
            ...
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
                if (f = d(f, e))
                    f.appendBogus(),
                    F = CKEDITOR.env.ie;
            h(b, e.block, n) && r.collapsed && !r.getCommonAncestor().isReadOnly() && (e = r.clone(),
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var h, g;
                    if (f)
                        for (; (h = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[h.getName()]) && 
                        (!g || !g[e]); )
                            h.getName() in CKEDITOR.dtd.span ? b.splitElement(h) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(h),
                            b.collapse(!0),
                            h.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                },
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        k && (k = new CKEDITOR.dom.range(c),
                        k.moveToElementEditStart(c),
                        b = b.createRange(),
                        b.setStart(k.startContainer.$, k.startOffset),
                        b.collapse(!0),
                        d.removeAllRanges(),
                        d.addRange(b))
                    }
                    function b() {
                        ...
                        "None" == d.type && k.equals(c) && (d = new CKEDITOR.dom.range(c),
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        n && (e = d.getHead(),
                        e.getCustomData("stylesheet") || (n = d.appendStyleText(n),
                        n = new CKEDITOR.dom.element(n.ownerNode || n.owningElement),
                        e.setCustomData("stylesheet", n),
                        n.data("cke-temp", 1)));
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in h) {
                                ...
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (k = b.getSelectedElement()) || (k = g(b)) ? (a.fire("saveSnapshot"),
                                e.moveToPosition(k, CKEDITOR.POSITION_BEFORE_START),
                                k.remove(),
                                e.select(),
                                a.fire("saveSnapshot"),
                                d = 1) : e.collapsed && ((p = n.block) && (l = p[c ? "getPrevious" : 
                                "getNext"](f)) && l.type == CKEDITOR.NODE_ELEMENT && l.is("table") && e[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"),
                                e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && p.remove(),
                                e["moveToElementEdit" + (c ? "End" : "Start")](l),
                                e.select(),
                                a.fire("saveSnapshot"),
                                d = 1) : n.blockLimit && n.blockLimit.is("td") && (w = n.blockLimit.getAscendant("table")) && e.checkBoundaryOfElement(w, c ? CKEDITOR.START : CKEDITOR.END) && (l = w[c ? "getPrevious" : "getNext"](f)) ? (a.fire("saveSnapshot"),
                                e["moveToElementEdit" + (c ? "End" : "Start")](l),
                                e.checkStartOfBlock() && e.checkEndOfBlock() ? l.remove() : e.select(),
                                a.fire("saveSnapshot"),
                                d = 1) : (w = n.contains(["td", "th", "caption"])) && e.checkBoundaryOfElement(w, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                            }
                            return !d
                        });
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) {
                            b.data.getKeystroke() in h && !this.getFirst(c) && (this.appendBogus(),
                            b = a.createRange(),
          ...
          , m = function() {
            ...
            function b(c, d) {
                ...
                l; ++g)
                    e = D.getItem(g),
                    a(e) ? (n = e.getName(),
                    q && n in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (p = !!r[n],
                    "br" != n || !e.data("cke-eol") || g && g != l - 1 || (t = (f = g ? h[g - 1].node : D.getItem(g + 1)) && (!a(f) || !f.is("br")),
                    f = f && a(f) && B.$block[f.getName()]),
                    -1 != F || p || (F = g),
                    p || (m = g),
                    h.push({
                        isElement: 1,
            ...
            function d(b, c) {
                ...
                for (g && e.push(" "); h < f; h++)
                    n = k.getItem(h),
                    a(n) && !n.is(r) ? e = e.concat(d(n, c)) : e.push(n);
                g && e.push(" ");
                return e
            }
            function e(b) {
            ...
            function r(b, c, d, e) {
                ...
                (n = f.getPrevious()) && a(n) && !n.getParent().equals(b.startContainer) && d.contains(n) && e.contains(f) && f.isIdentical(n) && (f.moveChildren(n),
                f.remove(),
                r(b, c, d, e))
            }
            function g(b, c) {
                ...
                e && d(e, b[b.length - 1]);
                k && d(k, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1),
                c.collapse())
            }
            var B = CKEDITOR.dtd
              , m = {
            ...
            return function(m, w, H, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    !0, !1) && (K = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", w.document),
                    w.insertNode(K),
                    w.setStartAfter(K));
                    ...
                    if (G = K.contains(f, !1, 1))
                        w.splitElement(G),
                        m.inlineStylesRoot = G,
                        m.inlineStylesPeak = K.lastElement;
                    K = w.createBookmark();
                    ...
                    if (K = H) {
                        ...
                        if ("text" == m.type && m.inlineStylesRoot) {
                            ...
                            for (I = 
                            m.inlineStylesRoot.getParent(); !u.equals(I); )
                                w = w.appendTo(u.clone()),
                                u = u.getParent();
                    ...
                    if (K) {
                        ...
                        for (g(w, z); I < w.length; I++) {
                            ...
                            if (v = L.isLineBreak) {
                                ...
                                ba == CKEDITOR.POSITION_IDENTICAL || ba == CKEDITOR.POSITION_CONTAINS ? v = 0 : (R = v.splitElement(U),
                                v.moveToPosition(R, CKEDITOR.POSITION_AFTER_START),
                                v = 1)) : v = 0
                            }
                            if (v)
                                H = 0 < I;
                                ...
                                v = 
                                z.startPath();
                                !L.isBlock && h(m.editor, v.block, v.blockLimit) && (E = l(m.editor)) && (E = K.createElement(E),
                                E.appendBogus(),
                                z.insertNode(E),
                                CKEDITOR.env.needsBrFiller && (C = E.getBogus()) && C.remove(),
                                z.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END));
                                ...
                                if (G && L.isElement) {
                                    ...
                                    if (v)
                                        ...
                                        v = I == w.length - 1;
                                        R = d(L.node, R);
                                        for (var U = [], ba = R.length, ca = 0, ea = void 0, Z = 0, V = -1; ca < ba; ca++)
                                            ea = R[ca],
                                            " " == ea ? (Z || Y && !ca || (U.push(new CKEDITOR.dom.text(" ")),
                                            V = U.length),
                                            Z = 1) : (U.push(ea),
                                            Z = 0);
                                        v && V == U.length && U.pop();
                                ...
                                if (Y) {
                                    ...
                                    z.insertNode(L.node);
                                L.lastNotAllowed && I < w.length - 1 && ((X = y ? J : X) && z.setEndAt(X, CKEDITOR.POSITION_AFTER_START),
                                G = 0);
                                z.collapse()
                            }
                        }
                        1 != w.length ? C = !1 : (C = w[0],
                        C = C.isElement && "false" == 
                        C.node.getAttribute("contenteditable"));
                        C && (H = !0,
                        v = w[0].node,
                        z.setStartAt(v, CKEDITOR.POSITION_BEFORE_START),
                        z.setEndAt(v, CKEDITOR.POSITION_AFTER_END));
                        m.dontMoveCaret = H;
                    ...
                    for (Y = C.createBookmark(); N = m.zombies.pop(); )
                        N.getParent() && (E = C.clone(),
                        E.moveToElementEditStart(N),
                        E.removeEmptyBlocksAtEnd());
                    if (X)
                        for (; N = X.pop(); )
          ...
          , E = {
            eol: {
                detect: function(a, b) {
                    ...
                    a.prependEolBr = 1);
                    h.block && e.checkBoundaryOfElement(h.block, CKEDITOR.START) && (c.setEndBefore(h.block),
                    a.appendEolBr = 1)
                },
                fix: function(a, b) {
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list),
          ...
          , v = function() {
            ...
            return {
                    ...
                    merge: function(a, c) {
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) {
                                ...
                                p.equals(g) || (g.moveChildren(p),
                                g.remove())
                            }
                            a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem),
                            h = h.contains(CKEDITOR.dtd.$listItem),
                            f.equals(h) || b(h, d, e));
                            d.remove();
                            e.remove()
                        }
                    ...
                    return {
                        detectPurge: function(a) {
                            ...
                            if (1 < e) {
                                ...
                                CKEDITOR.START) && b.checkBoundaryOfElement(f, CKEDITOR.END) && (b = a.range.clone(),
                                b.setStartBefore(c),
                                b.setEndAfter(f),
                        ...
                        detectRanges: function(e, f) {
                            ...
                            l = l.contains("table");
                            if (w || l)
                                w && l && b(w, l) ? (e.tableSurroundingRange = 
                                h,
                                h.setStartAt(w, CKEDITOR.POSITION_AFTER_END),
                                h.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
                                h = k.clone(),
                                h.setEndAt(w, CKEDITOR.POSITION_AFTER_END),
                                g = k.clone(),
                                g.setStartAt(l, CKEDITOR.POSITION_BEFORE_START),
                                g = a(h).concat(a(g))) : w ? l || (e.tableSurroundingRange = h,
                                h.setStartAt(w, CKEDITOR.POSITION_AFTER_END),
                                k.setEndAt(w, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = h,
                                h.setEndAt(l, CKEDITOR.POSITION_BEFORE_START),
                                k.setStartAt(l, CKEDITOR.POSITION_AFTER_START)),
                                e.tableContentsRanges = g ? g : a(k)
                        },
                ...
                autoParagraph: function(a, b) {
                    var c = b.startPath(), d;
                    h(a, c.block, c.blockLimit) && (d = l(a)) && (d = b.document.createElement(d),
                    d.appendBogus(),
                    b.insertNode(d),
    ...
    (function() {
        ...
        function b() {
            u = null ;
            C && (CKEDITOR.tools.setTimeout(a, 0, this),
            C = !1)
        }
        function c(a) {
        ...
        function h(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    ...
                    1 < c.getLength() && f && f.intersectsNode(c.$) && (d = q(e),
                    f = e.focusNode == c.$ && 0 < e.focusOffset,
                    e.anchorNode == c.$ && 0 < e.anchorOffset && d[0].offset--,
                    f && d[1].offset--)
                }
            ...
            return function(c) {
                ...
                if (b[d]) {
                    var e = a.getSelection().getRanges()
                      , f = e[0];
                    1 == e.length && 
                    f.collapsed && (d = f[38 > d ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type == CKEDITOR.NODE_ELEMENT && "false" == d.getAttribute("contenteditable") && (a.getSelection().fake(d),
                ...
                if (!c.collapsed) {
                    if (c.startContainer.isReadOnly())
                        for (var d = c.startContainer, e; d && !((e = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body") || !d.isReadOnly()); )
                            e && "false" == d.getAttribute("contentEditable") && 
                            c.setStartAfter(d),
                            d = d.getParent();
                    d = c.startContainer;
                    e = c.endContainer;
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && g.attachListener(g, "focus", function(a) {
                    a.removeListener();
                    0 !== w && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(),
                ...
                if (CKEDITOR.env.ie || m)
                    E ? g.attachListener(g, "beforedeactivate", b, null , null , -1) : g.attachListener(e, "selectionCheck", b, null , null , -1),
                ...
                if (CKEDITOR.env.ie && !m) {
                    ...
                    g.attachListener(g, "mouseup", function(a) {
                        2 == a.data.$.button && I && (e.document.$.documentElement.scrollLeft = I.x,
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version)
                            l.on("mousedown", 
                            function(a) {
                                a.data.getTarget().is("html") && (k.on("mouseup", c),
                                l.on("mouseup", c))
                            })
                    }
                }
                ...
                if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    g.attachListener(CKEDITOR.env.ie ? 
        ...
        CKEDITOR.dom.selection.prototype = {
                    ...
                    var b = function(b, c) {
                        ...
                        if (-1 == l || l == e.length - 1 && 0 > n) {
                            ...
                            for (d = e.length; 0 < h && 0 < d; )
                                k = e[--d],
                                k.nodeType == 
                                CKEDITOR.NODE_TEXT && (m = k,
                                h -= k.nodeValue.length);
                            return {
                                container: m,
                                offset: -h
                            }
                        ...
                        for (; 0 < h; )
                            try {
                                k = f[0 < n ? "previousSibling" : "nextSibling"],
                                k.nodeType == CKEDITOR.NODE_TEXT && (h -= k.nodeValue.length,
                                m = k),
                                f = k
                            } catch (t) {
                                return {
                ...
                case CKEDITOR.SELECTION_TEXT:
                    ...
                    if (c) {
                        if (c.collapsed)
                            ...
                            c.startOffset == (b.getChildCount ? 
                            b.getChildCount() : b.getLength()) && !b.isBlockBoundary(); )
                                c.setStartAfter(b);
                            b = c.startContainer;
                            if (b.type != CKEDITOR.NODE_ELEMENT)
                                return b.getParent();
            ...
            getSelectedElement: function() {
                ...
                function() {
                    for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && x[c.getName()] && (d = c)); e--)
            ...
            selectRanges: function(a) {
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var l, m;
                            if (1 == a.length && !(m = a[0]).collapsed && (g = m.getEnclosedNode()) && g.type == CKEDITOR.NODE_ELEMENT && (m = m.clone(),
                            m.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
                            (l = m.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (g = l),
                        ...
                        if (g)
                            ...
                            if (E) {
                                ...
                                CKEDITOR.NODE_ELEMENT && g.endContainer.getName() in b)
                                    g.shrink(CKEDITOR.NODE_ELEMENT, !0),
                                    a = g.collapsed;
                                u = g.createBookmark();
                                b = u.startNode;
                                a || (f = u.endNode);
                                ...
                                f ? (l = g.document.$.body.createTextRange(),
                                l.moveToElementText(f.$),
                                u.setEndPoint("EndToEnd", l),
                                u.moveEnd("character", -1)) : (t = b.getNext(m),
                                q = b.hasAscendant("pre"),
                                t = !(t && t.getText && t.getText().match(l)) && (q || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")),
                                q = g.document.createElement("span"),
                                q.setHtml("\x26#65279;"),
                                q.insertBefore(b),
                                t && g.document.createText("﻿").insertBefore(b));
                                g.setStartBefore(b);
                                b.remove();
                                a ? (t ? (u.moveStart("character", -1),
                                u.select(),
                                g.document.$.selection.clear()) : u.select(),
                                g.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START),
                                q.remove()) : (g.setEndBefore(f),
                                f.remove(),
                                u.select())
                            } else {
                                f = this.getNative();
                                ...
                                for (u = 0; u < a.length; u++) {
                                    if (u < a.length - 1 && (t = a[u],
                                    q = a[u + 1],
                                    l = t.clone(),
                                    l.setStart(t.endContainer, 
                                    t.endOffset),
                                    l.setEnd(q.startContainer, q.startOffset),
                                    !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0),
                                    g = l.getCommonAncestor(),
                                    l = l.getEnclosedNode(),
                                    g.isReadOnly() || l && l.isReadOnly()))) {
                                    ...
                                    g.collapsed && CKEDITOR.env.webkit && e(g) && (t = this.root,
                                    h(t, !1),
                                    l = t.getDocument().createText("​"),
                                    t.setCustomData("cke-fillingChar", l),
                                    g.insertNode(l),
                                    (t = l.getNext()) && !l.getPrevious() && t.type == CKEDITOR.NODE_ELEMENT && 
                                    "br" == t.getName() ? (h(this.root),
                                    g.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START)) : g.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
    ...
    (function() {
                ...
                for (r.getPosition(q) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r; ) {
                    ...
                    if (r.equals(q))
                        ...
                        if (y)
                            ...
                            D = h,
                            F = k,
                            !B || !(B.getDtd() || CKEDITOR.dtd.span)[D] && !F || y.parentRule && !y.parentRule(B))
                                l = !0;
                            else {
                                if (u || 
                                v && CKEDITOR.dtd.$removeEmpty[v] && (r.getPosition(q) | M) != M || (u = c.clone(),
                                u.setStartBefore(r)),
                                v = r.type,
                                v == CKEDITOR.NODE_TEXT || x || v == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                    for (var v = r, Z; (l = !v.getNext(L)) && (Z = v.getParent(),
                                    n[Z.getName()]) && d(Z, t, g, S); )
                                        v = Z;
                                    u.setEndAfter(v)
                                }
                            }
                    ...
                    if (l && u && !u.collapsed) {
                        ...
                        l ? (u.extractContents().appendTo(l),
                        u.insertNode(l),
                        C.call(this, l),
                        l.mergeSiblings(),
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(),a.root), f, h = 0, g; h < e.elements.length && (g = e.elements[h]) && g != e.block && g != e.blockLimit; h++)
                    if (this.checkElementRemovable(g)) {
                        var l;
                        a.collapsed && (a.checkBoundaryOfElement(g, CKEDITOR.END) || (l = a.checkBoundaryOfElement(g, CKEDITOR.START))) ? (f = g,
                        f.match = l ? "start" : "end") : (g.mergeSiblings(),
                        g.is(this.element) ? u.call(this, g) : m(g, k(this)[g.getName()]))
                    }
                if (f) {
                    g = d;
                    for (h = 0; ; h++) {
                ...
                for (e = d; !e.equals(n); )
                    ...
                    e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? u.call(this, e) : m(e, k(this)[e.getName()]),
        ...
        function l(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph(); )
                !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = E(this, e, d),
                t(d, f));
            a.moveToBookmark(b)
        }
        function q(a) {
        ...
        function u(a, b) {
            ...
            for (g in d)
                if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == p(g, d[g]))
                    ...
                    a.removeAttribute(g));
            for (var h in c)
                this._.definition.fullMatch && a.getStyle(h) != p(h, c[h], !0) || (f = f || !!a.getStyle(h),
                a.removeStyle(h));
            m(a, e, D[a.getName()]);
            ...
            do
                if (q.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    q.is(CKEDITOR.dtd.$object) || "false" == q.getAttribute("contenteditable")))
                        ...
                        break;
                    if (!h && (t = q.getName(),
                    "true" == q.getAttribute("contenteditable") ? h = q : !g && d[t] && (g = q),
                    a[t])) {
                        if (t = !g && "div" == t) {
                            a: {
                                t = q.getChildren();
    ...
    (function() {
        function a(a, c, d) {
            ...
            h.equals(q.getPrevious()) ? (c.startOffset = c.startOffset - h.getLength() - a.getPrevious().getLength(),
...
*/
    ...
    (function() {
        ...
        function y(b) {
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    m.setAttribute("contenteditable", !0)) : m.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-1000px");
        ...
        function D() {
            ...
            return {
                get: function(c) {
                    return "plain-text" == c ? a.plainText || (a.plainText = new CKEDITOR.filter("br")) : "semantic-content" == c ? ((c = a.semanticContent) || (c = new CKEDITOR.filter,
                    c.allow({
                        $1: {
                            elements: b(),
                            attributes: !0,
            ...
            fixSplitNodesAfterDrop: function(b, a, c, d) {
                function e(b, c, d) {
                    ...
                    if (e.equals(c) && d != c.getChildCount())
                        return b = 
                        a.startContainer.getChild(a.startOffset - 1),
                        c = a.startContainer.getChild(a.startOffset),
                        b && b.type == CKEDITOR.NODE_TEXT && c && c.type == CKEDITOR.NODE_TEXT && (d = b.getLength(),
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function(b) {
                ...
                a = a.replace(this._.fragmentRegExp, ""))) : "Text" == b && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 
                7) && (a = "");
                return a
            },
